...
class UserProductMvcTest {
    ...
    private void mockUserSetup() {//api 호출할때 필요한  유저 정보
        // Mock 테스트 유져 생성
    ...
    void test2() throws Exception {
        ...
        mvc.perform(post("/api/user/signup")//
                ...
                .andExpect(status().is3xxRedirection())//리다이렉트 스테이터스
                .andExpect(view().name("redirect:/api/user/login-page"))//반환하는 뷰 네임
                .andDo(print());
    }
    ...
    void test3() throws Exception {
        ...
        String postInfo = objectMapper.writeValueAsString(requestDto);//서버에서 Json을 읽을수 없기 때문에 Json형식을 String형식으로 바꿈
